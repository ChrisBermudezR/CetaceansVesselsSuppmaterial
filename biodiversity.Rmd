...
In addition to public databases, we used unpublished data collected in the oceanographic cruises of the *National Maritime Directorate of Colombia* ( *DIMAR*, for its acronym in Spanish), which were conducted in the frame of the ENSO Regional Study (*ERFEN*, for its acronym in Spanish) through the *Centro de Investigaciones Oceanográficas e Hidrográficas del Pacífico -- CCCP* (Supplementary Table 1). 

The filtering of databases and the cleaning of duplicate records were carried out using a R language [script](https://github.com/ChrisBermudezR/Cetacean_Tourist_Vessel_Collision_Risk_Assessment/blob/main/02_Species_Occurrences/01_Occurrence_Data_Download.R)  [@RTeam2008] with the "*tidyverse*" (v. 1.2.0; @Wickham2017), "*dplyr*" (v. 1.0; @Wickham2019), "*anytime*" (v. 0.3.7; @Eddelbuettel2020), "*rgdal*" (v. 1.5-12; @Bivand2020), "*gdata*" (v. 2.18.0; @Warnes2012), and "*devtools*" (v. 2.3.1; @Wickham2020) packages.
